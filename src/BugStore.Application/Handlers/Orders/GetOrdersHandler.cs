...
{
    public async Task<Response<IEnumerable<Order>>> HandleAsync(GetOrdersRequest req, CancellationToken cancellationToken = default)
    {
        var searchResult = await orderRepository.GetPagedAsync(req, cancellationToken);
